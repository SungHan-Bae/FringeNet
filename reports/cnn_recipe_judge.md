...
- 표본 5,000행 (holdout 무작위, 시드 0) — **모든 run이 같은 행을 본다**
...
|---|---|---|---|---|---|---|---|---|---|
| `level1_cnn/flatten-dilated-bound` | 30 | — | 2.3455 | 2.4208 | **0.6643** | 0.78% | 0.2520 | 2.1176 | — |
...
| run | 실측 | 모형 | 차 |
|---|---|---|---|
| `level1_cnn/flatten-dilated-bound` | 0.6643 | 0.6420 | +0.0223 |
...
|---|---|---|---|---|---|---|---|
| `level1_cnn/flatten-dilated-bound` | 0.018538 | 0.007814 | 2.4× | 64.1% | 100.0% | 74.4% | 58.0% |
